...
void writeDisplay()
{
  ...
  do
  {
    ...
    epd.drawBitmap(OFFSET_LEFT + 50 , OFFSET_TOP + weatherdetails_offset - GLYPH_SIZE_WEATHER / 2, weather_icon, GLYPH_SIZE_WEATHER, GLYPH_SIZE_WEATHER_, kleur);
    epd.setCursor(OFFSET_LEFT + 110, OFFSET_TOP + weatherdetails_offset + GLYPH_SIZE_WEATHER / 4);
